...
//   let AllCarts = [
//     { title: "Android", name: "A20", price: "425", imgSrc: "مالک.jpg" },
//     { title: "IOS", name: "X14", price: "290", imgSrc: "مهستان-bg.jpg" },
//     { title: "Android", name: "A30", price: "720", imgSrc: "ولنتاین.jpg" },
//     { title: "IOS", name: "X10", price: "300", imgSrc: "logo192.png" },
//     { title: "Android", name: "A71", price: "410", imgSrc: "logo512.png" },
//   ]
...
//         <Cart {...AllCarts[0]}></Cart>
//         <Cart {...AllCarts[1]}></Cart>
//         <Cart {...AllCarts[2]}></Cart>
//         <Cart {...AllCarts[3]}></Cart>
//         <Cart {...AllCarts[4]}></Cart>
//       </div>
//       <Article></Article>
//       <Article></Article>
//     </div>
  ...
  render() {
    ...
    return (
      <div className="nav-container">
        ...
        <div className="AllCart">
          {this.state.AllCarts.map((cart) => (
            <Cart {...cart} key={cart.id} onRemove={this.removeCartHandler} />
          ))}
        </div>
      </div>
    )
